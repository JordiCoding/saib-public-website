...
const MarginLendingUnlockSection: React.FC = () => {
    ...
    >
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:pr-30">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-y-12 lg:gap-x-[80px] rtl:lg:flex-row-reverse">
          ...
          >
            <img
              src="/images/marginsection.png"
              alt="Margin Lending Unlock"
          ...
          >
            <div className="text-center lg:text-right">
              ...
              <h2 className={`text-4xl lg:text-5xl font-bold text-icap-primary ${getTypographyClasses('title')} ${isArabic ? 'leading-relaxed' : 'leading-tight'}`}>
                <Trans
                  i18nKey="marginLendingUnlock.title"
                  components={[
                    <span className="text-[#A44F17]" />, // <0> - Unlock More
                    <br />, // <1/> - line breaks
                  ]}
                />
              </h2>
              ...
              {/* Subtitle */}
              <p className={`text-lg max-w-xl text-black ${getTypographyClasses('body')}`}>
                <Trans
                  i18nKey="marginLendingUnlock.subtitle"
                  components={[<br />]}
                />
              </p>
            </div>
...
export default MarginLendingUnlockSection;
